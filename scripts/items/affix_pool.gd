...
const DEFS: Array[Dictionary] = [
	...
	{"id": &"storm_cd_pct", "template": "Storm Step cooldown -%d%%", "stat": &"storm_cd_pct",
...
const LEGENDARIES: Array[Dictionary] = [
	...
	{"id": &"conductors_oath", "name": "Conductor's Oath", "slot": ItemData.Slot.AMULET,
		"text": "Enemies struck by Chain Spark become Conductors. Lightning damage arcs between Conductors."},
	{"id": &"glacier_heart", "name": "Glacier Heart", "slot": ItemData.Slot.CHEST,
		"text": "Earthbreaker leaves a field of frost that Chills enemies."},
	{"id": &"split_lance", "name": "Forked Ember", "slot": ItemData.Slot.WEAPON,
		"text": "Ember Lance splits into two half-damage lances on its first hit."},
	{"id": &"overload", "name": "Stormcaller's Band", "slot": ItemData.Slot.RING,
		"text": "Storm Step's end point Shocks every enemy within 2.5 m."},
	{"id": &"molten_core", "name": "Emberheart Plate", "slot": ItemData.Slot.CHEST,
